...
export default function TicketInfo({ incident, onUpdate }) {
  ...
  const labelClasses = "block text-[8px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-[0.1em] mb-1 flex items-center gap-1.5";
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 px-6 py-3 bg-zinc-50/50 dark:bg-zinc-900/10 border-b border-zinc-200 dark:border-zinc-800">
      ...
      <div className="group">
        ...
        <input
          type="text"
          className={`${inputClasses} font-mono text-blue-600 dark:text-blue-400 uppercase`}
